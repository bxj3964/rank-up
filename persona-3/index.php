...
?>
			...
			<a>
				<img id="p5" src="<?php echo $path?>media/p5_alt.png" alt="Persona 5 Logo" onmouseover="this.src='<?php echo $path?>media/p5_alt_glow.png';" onmouseout="this.src='<?php echo $path?>media/p5_alt.png';">
			</a>
			<div id="bottom">
